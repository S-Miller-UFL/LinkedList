...
//CUSTOM FUNCTION, DO NOT INCLUDE IN SUBMISSION.
void Testcomparison()
{
	//CUSTOM TEST WRITTEN BY STEVEN MILLER ON 2/14/2022. DO NOT INCLUDE IN SUBMISSION FILE.
	//Testing comparison overload operator
	LinkedList<int> int1;
	//LinkedList<int>::Node
	int arr1[] = { 0,1,2,3,4,5 };
	int1.AddNodesHead(arr1, 6);
	LinkedList<int> int2;
	int arr2[] = { 0,1,2,3,4,5 };
	int2.AddNodesHead(arr2, 6);
	if (int1 == int2)
	{
		cout << "the comparison function works!";
	}
	else
	{
